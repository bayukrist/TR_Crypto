...
class AccountViewModel @ViewModelInject constructor(private val repository: SettingsRepository) : BaseViewModel() {
    ...
    fun onThemeChanged(isDarkMode: Boolean) {
        ...
        this@AccountViewModel._isDarkMode.value = isDarkMode
    }
}